      ...
      {open && (
        <div className="flex flex-col gap-2 mb-1 animate-in fade-in slide-in-from-bottom-4 duration-200">
          <a
            ...
            className="flex items-center gap-3 bg-white dark:bg-zinc-800 rounded-full pl-4 pr-5 py-2.5 shadow-lg hover:shadow-xl transition-all hover:scale-105 group"
          ...
          >
            ...
            <span className="text-sm font-medium whitespace-nowrap">Позвонить</span>
          </a>
        </div>
      )}
